...
gui_load_child_values {IB_tb.dut.IB_ALU_inst.IB_ALU_queue_inst}


set _session_group_1 IB_ALU_queue_inst
...
catch {gui_list_expand -id ${Hier.1} IB_tb.dut.IB_ALU_inst}
catch {gui_list_select -id ${Hier.1} {IB_tb.dut.IB_ALU_inst.IB_ALU_queue_inst}}
...
gui_list_show_data -id ${Data.1} {IB_tb.dut.IB_ALU_inst.IB_ALU_queue_inst}
